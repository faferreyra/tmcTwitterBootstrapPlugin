    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <button class="btn btn-primary" data-toggle="modal" data-target="#admin-bs-filters">
                    [?php echo __('Show filters', array(), 'tmcTwitterBootstrapPlugin'); ?]
                </button>
            </div>
            <?php endif; ?>
            <div class="panel-body panel-no-padding">
                ...
                <div class="alert alert-info">[?php echo __('No result', array(), 'sf_admin') ?]</div>
                [?php else: ?]
